--TEST--
Silence operator does not leak into fiber+preg_match() single line match with latin input
--INI--
...
preg_match('/^[\w\p{Cyrillic}\s\-\']+$/u', 'ÐºÐ¸ÑÐ¸Ð»Ð»Ð¸ÑÐ°', $test2);
preg_match('/^[\w\s\-\']+$/u', 'latin', $fusion);
