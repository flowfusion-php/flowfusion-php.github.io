--TEST--
Bug #43221 (SimpleXML adding default namespace in addAttribute)+GH-11189: Exceeding memory limit in zend_hash_do_resize leaves the array in an invalid state (packed array)
--INI--
memory_limit=2M
max_input_vars=100
expose_php=On
